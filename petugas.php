...
<head>
	...
	<link rel="stylesheet" type="text/css" href="css/admin.css">
		...
		if(isset($_SESSION['user2']) || isset($_COOKIE['ingat'])){ 
		?>
<body>
<div class="container">
	<!--HEADER-->
	<header class="header" id="header">
		...
		<nav class="navigasi" id="navigasi">
			...
			<span class="user"><?php echo $_SESSION['user2'];?></span>
	...
	<aside class="main-sidebar" id="main-sidebar">
		<section class="sidebar">
			<div class="user-panel">
				<span class="nama"><?php echo $_SESSION['nama2'];?> - </span>
				<span class="email"><?php echo $_SESSION['level2'];?></span>
			</div>
			<ul class="sidebar-menu">
				<p class="head-menu">MAIN NAVIGATION</p>
				<li <?php if($form==1){echo'class="active"';} else{echo'class=""';} ?>>
					<a href="petugas.php?form=1">Dashboard</a>
				</li>
				<li <?php if($form==2){echo 'class="active"';} else{echo'class=""';} ?>>
					<a href="petugas.php?form=2"?>Verifikasi</a>
				</li>
				<li <?php if($form==3){echo'class="active"';}else{echo'class=""';}?>>
					<a href="petugas.php?form=3">Tiket</a>
				</li>
				<li>
	...
	<content class="wrapper-content">
		<?php
			switch($form)
			{
				...
				case('2'): include_once('form/tbverify.php'); break;
				case('3'): include_once('form/tbtiket1.php'); break;
...
<?php } else{header('location:index.php?msg=3');}?>
</body>
</html>